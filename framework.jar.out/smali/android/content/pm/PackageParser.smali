...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/content/pm/PackageParser$CollectCertificatesTask;,
...
.method static synthetic access$200(Landroid/content/pm/PackageParser;Ljava/util/jar/JarFile;Ljava/util/jar/JarEntry;[BZ)[Ljava/security/cert/Certificate;
    .locals 1
    .param p0, "x0"    # Landroid/content/pm/PackageParser;
    .param p1, "x1"    # Ljava/util/jar/JarFile;
    .param p2, "x2"    # Ljava/util/jar/JarEntry;
    .param p3, "x3"    # [B
    .param p4, "x4"    # Z

    .prologue
    .line 83
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/content/pm/PackageParser;->loadCertificates(Ljava/util/jar/JarFile;Ljava/util/jar/JarEntry;[BZ)[Ljava/security/cert/Certificate;
...
.method private loadCertificates(Ljava/util/jar/JarFile;Ljava/util/jar/JarEntry;[BZ)[Ljava/security/cert/Certificate;
    .locals 6
    .param p1, "jarFile"    # Ljava/util/jar/JarFile;
    .param p2, "je"    # Ljava/util/jar/JarEntry;
    .param p3, "readBuffer"    # [B
    .param p4, "withBufferInputStream"    # Z
...
.method public collectCertificates(Landroid/content/pm/PackageParser$Package;I)Z
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/content/pm/PackageParser;->collectCertificates(Landroid/content/pm/PackageParser$Package;II)Z
    ...
    .line 694
    invoke-virtual {v12, v13}, Ljava/util/jar/JarFile;->getInputStream(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;

    move-result-object v19

    invoke-static/range {v19 .. v19}, Landroid/content/pm/ManifestDigest;->fromInputStream(Ljava/io/InputStream;)Landroid/content/pm/ManifestDigest;
...
.method public collectCertificates(Landroid/content/pm/PackageParser$Package;II)Z
    .locals 26
    .param p1, "pkg"    # Landroid/content/pm/PackageParser$Package;
    .param p2, "flags"    # I
    ...
    sget-object v24, Landroid/content/pm/PackageParser;->mSync:Ljava/lang/Object;

    monitor-enter v24

    .line 4318
    :try_start_0
    sget-object v20, Landroid/content/pm/PackageParser;->mReadBuffer:Ljava/lang/ref/WeakReference;
    ...
    sput-object v3, Landroid/content/pm/PackageParser;->mReadBuffer:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {v4, v3, v0, v1}, Ljava/util/jar/JarFile;-><init>(Ljava/lang/String;ZZ)V
    ...
    check-cast v11, Ljava/util/concurrent/ThreadPoolExecutor;

    .line 4335
    .local v11, "executor":Ljava/util/concurrent/ThreadPoolExecutor;
    new-instance v22, Ljava/util/ArrayList;

    invoke-direct/range {v22 .. v22}, Ljava/util/ArrayList;-><init>()V

    .line 4336
    .local v22, "resultList":Ljava/util/List;, "Ljava/util/List<Ljava/util/concurrent/Future<Ljava/lang/String;>;>;"
    new-instance v6, Landroid/content/pm/PackageParser$ReadBufferLruCache;
    ...
    invoke-direct {v6, v0, v3}, Landroid/content/pm/PackageParser$ReadBufferLruCache;-><init>(Landroid/content/pm/PackageParser;I)V

    .line 4337
    .local v6, "lruCache":Landroid/content/pm/PackageParser$ReadBufferLruCache;
    const/4 v5, 0x0

    .line 4338
    .local v5, "jeList":Ljava/util/List;, "Ljava/util/List<Ljava/util/jar/JarEntry;>;"
    const/16 v17, 0xa

    .line 4340
    .local v17, "maxJeNum":I
    ...
    invoke-virtual {v4, v3}, Ljava/util/jar/JarFile;->getJarEntry(Ljava/lang/String;)Ljava/util/jar/JarEntry;

    move-result-object v14

    .line 4346
    .local v14, "jarEntry":Ljava/util/jar/JarEntry;
    move-object/from16 v0, p0

    move-object/from16 v1, v19

    invoke-direct {v0, v4, v14, v1}, Landroid/content/pm/PackageParser;->loadCertificates(Ljava/util/jar/JarFile;Ljava/util/jar/JarEntry;[B)[Ljava/security/cert/Certificate;
    ...
    const-string v25, " has no certificates at entry "

    invoke-virtual/range {v24 .. v25}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v24

    invoke-virtual {v14}, Ljava/util/jar/JarEntry;->getName()Ljava/lang/String;
    ...
    .end local v5    # "jeList":Ljava/util/List;, "Ljava/util/List<Ljava/util/jar/JarEntry;>;"
    .end local v6    # "lruCache":Landroid/content/pm/PackageParser$ReadBufferLruCache;
    .end local v7    # "certs":[Ljava/security/cert/Certificate;
    .end local v11    # "executor":Ljava/util/concurrent/ThreadPoolExecutor;
    .end local v14    # "jarEntry":Ljava/util/jar/JarEntry;
    .end local v17    # "maxJeNum":I
    .end local v22    # "resultList":Ljava/util/List;, "Ljava/util/List<Ljava/util/concurrent/Future<Ljava/lang/String;>;>;"
    :goto_0
    return v3
    ...
    .restart local v5    # "jeList":Ljava/util/List;, "Ljava/util/List<Ljava/util/jar/JarEntry;>;"
    .restart local v6    # "lruCache":Landroid/content/pm/PackageParser$ReadBufferLruCache;
    .restart local v7    # "certs":[Ljava/security/cert/Certificate;
    .restart local v11    # "executor":Ljava/util/concurrent/ThreadPoolExecutor;
    .restart local v17    # "maxJeNum":I
    .restart local v20    # "readBufferRef":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<[B>;"
    .restart local v22    # "resultList":Ljava/util/List;, "Ljava/util/List<Ljava/util/concurrent/Future<Ljava/lang/String;>;>;"
    :cond_3
    :try_start_3
    ...
    iput-object v3, v0, Landroid/content/pm/PackageParser$Package;->manifestDigest:Landroid/content/pm/ManifestDigest;
    ...
    invoke-direct {v0, v4, v15, v1}, Landroid/content/pm/PackageParser;->loadCertificates(Ljava/util/jar/JarFile;Ljava/util/jar/JarEntry;[B)[Ljava/security/cert/Certificate;

    move-result-object v16

    .line 4391
    .local v16, "localCerts":[Ljava/security/cert/Certificate;
    if-nez v16, :cond_6
    ...
    .line 4396
    invoke-virtual {v6}, Landroid/content/pm/PackageParser$ReadBufferLruCache;->evictAll()V
    ...
    .line 4404
    .end local v16    # "localCerts":[Ljava/security/cert/Certificate;
    :cond_7
    if-nez v5, :cond_8
    ...
    .line 4409
    new-instance v2, Landroid/content/pm/PackageParser$CollectCertificatesTask;

    move-object/from16 v3, p0

    invoke-direct/range {v2 .. v7}, Landroid/content/pm/PackageParser$CollectCertificatesTask;-><init>(Landroid/content/pm/PackageParser;Ljava/util/jar/JarFile;Ljava/util/List;Landroid/content/pm/PackageParser$ReadBufferLruCache;[Ljava/security/cert/Certificate;)V

    .line 4410
    .local v2, "task":Landroid/content/pm/PackageParser$CollectCertificatesTask;
    const/4 v5, 0x0

    .line 4411
    invoke-virtual {v11, v2}, Ljava/util/concurrent/ThreadPoolExecutor;->submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;

    move-result-object v21

    .line 4412
    .local v21, "result":Ljava/util/concurrent/Future;, "Ljava/util/concurrent/Future<Ljava/lang/String;>;"
    ...
    .line 4486
    .end local v2    # "task":Landroid/content/pm/PackageParser$CollectCertificatesTask;
    .end local v4    # "jarFile":Ljava/util/jar/JarFile;
    .end local v5    # "jeList":Ljava/util/List;, "Ljava/util/List<Ljava/util/jar/JarEntry;>;"
    .end local v6    # "lruCache":Landroid/content/pm/PackageParser$ReadBufferLruCache;
    .end local v7    # "certs":[Ljava/security/cert/Certificate;
    ...
    .end local v21    # "result":Ljava/util/concurrent/Future;, "Ljava/util/concurrent/Future<Ljava/lang/String;>;"
    .end local v22    # "resultList":Ljava/util/List;, "Ljava/util/List<Ljava/util/concurrent/Future<Ljava/lang/String;>;>;"
    :catch_0
    move-exception v9
    ...
    invoke-static {v3, v0, v9}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    .line 4420
    .restart local v2    # "task":Landroid/content/pm/PackageParser$CollectCertificatesTask;
    const/4 v5, 0x0
    ...
    .line 4422
    .restart local v21    # "result":Ljava/util/concurrent/Future;, "Ljava/util/concurrent/Future<Ljava/lang/String;>;"
    move-object/from16 v0, v22
    ...
    check-cast v21, Ljava/util/concurrent/Future;
    :try_end_4
    ...
    .line 4432
    const-string v3, "INSTALL_PARSE_FAILED_NO_CERTIFICATES"
    ...
    .line 4463
    :try_start_9
    sput-object v20, Landroid/content/pm/PackageParser;->mReadBuffer:Ljava/lang/ref/WeakReference;
    ...
    aget-object v25, v7, v13

    invoke-virtual/range {v25 .. v25}, Ljava/security/cert/Certificate;->getEncoded()[B

    move-result-object v25

    invoke-direct/range {v24 .. v25}, Landroid/content/pm/Signature;-><init>([B)V

    aput-object v24, v3, v13
    :try_end_a
    .catch Ljava/security/cert/CertificateEncodingException; {:try_start_a .. :try_end_a} :catch_0
    ...
    throw v3
    :try_end_c
    .catch Ljava/security/cert/CertificateEncodingException; {:try_start_c .. :try_end_c} :catch_0
    ...
    .end local v7    # "certs":[Ljava/security/cert/Certificate;
    .end local v11    # "executor":Ljava/util/concurrent/ThreadPoolExecutor;
    .end local v12    # "executorResult":Z
    .end local v13    # "i":I
    .end local v17    # "maxJeNum":I
    .end local v22    # "resultList":Ljava/util/List;, "Ljava/util/List<Ljava/util/concurrent/Future<Ljava/lang/String;>;>;"
    :catch_3
    ...
    .restart local v7    # "certs":[Ljava/security/cert/Certificate;
    .restart local v11    # "executor":Ljava/util/concurrent/ThreadPoolExecutor;
    .restart local v12    # "executorResult":Z
    ...
    const-string v25, " has no certificates; ignoring!"
    ...
    iput-object v3, v0, Landroid/content/pm/PackageParser$Package;->mSigningKeys:Ljava/util/Set;
    ...
    iget-object v3, v0, Landroid/content/pm/PackageParser$Package;->mSigningKeys:Ljava/util/Set;
    ...
    :try_end_d
    .catch Ljava/security/cert/CertificateEncodingException; {:try_start_d .. :try_end_d} :catch_0
