...
.method private filterMediaKeyEvent(Landroid/view/KeyEvent;Z)V
    ...
    .line 753
    :cond_0
    sget-object v4, Landroid/media/MediaFocusControl;->mRingingLock:Ljava/lang/Object;
    ...
    .line 756
    :try_start_1
    iget-object v6, p0, Landroid/media/MediaFocusControl;->mAudioService:Landroid/media/AudioService;
    ...
    .local v2, "sipPhone":Z
    :goto_2
    iget-object v3, p0, Landroid/media/MediaFocusControl;->mMediaReceiverForCalls:Landroid/content/ComponentName;

    if-eqz v3, :cond_4

    iget-boolean v3, p0, Landroid/media/MediaFocusControl;->mIsRinging:Z
    ...
    .line 768
    .end local v0    # "isHeadsetHookKey":Z
    .end local v1    # "mode":I
    .end local v2    # "sipPhone":Z
    :catchall_0
    move-exception v3
    ...
    .restart local v0    # "isHeadsetHookKey":Z
    :cond_3
    move v2, v3
    ...
    invoke-static {v3}, Landroid/media/MediaFocusControl;->isValidVoiceInputKeyCode(I)Z
