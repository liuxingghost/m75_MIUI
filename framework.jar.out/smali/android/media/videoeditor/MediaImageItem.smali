...
.method private scaleImage(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    const-string v14, "MediaImageItem"

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string v16, ">> generateThumbnail: Input: "
    ...
    const-string v16, "generateThumbnail sampleSize from: "
    ...
    const-string v16, "generateThumbnail sampleSize to: "
    ...
    const-string v15, "generateThumbnail the sampleSize is to big, need x2"
    ...
    const-string v15, "generateThumbnail: Cannot decode image bytes"
    ...
    const-string v16, "Cannot decode file: "
    ...
    sget-object v16, Landroid/media/videoeditor/MediaImageItem;->sResizePaint:Landroid/graphics/Paint;

    move-object/from16 v0, v16

    invoke-virtual {v4, v12, v14, v15, v0}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public getThumbnailList(IIJJI[ILandroid/media/videoeditor/MediaItem$GetThumbnailListCallback;)V
    ...
    .line 627
    const-string v3, "MediaImageItem"

    const-string v4, "getThumbnailList scaleImage"
