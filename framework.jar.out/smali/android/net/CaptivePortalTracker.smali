...
.method private isCaptivePortal(Ljava/net/InetAddress;)Z
    ...
    invoke-virtual {v12, v1}, Ljava/net/HttpURLConnection;->setInstanceFollowRedirects(Z)V

    .line 397
    const/16 v1, 0x2710

    invoke-virtual {v12, v1}, Ljava/net/HttpURLConnection;->setConnectTimeout(I)V

    .line 398
    const/16 v1, 0x2710

    invoke-virtual {v12, v1}, Ljava/net/HttpURLConnection;->setReadTimeout(I)V

    .line 399
    const/4 v1, 0x0

    invoke-virtual {v12, v1}, Ljava/net/HttpURLConnection;->setUseCaches(Z)V
    ...
    .line 427
    .local v9, "ee":Ljava/lang/NumberFormatException;
    if-eqz v12, :cond_5
    ...
    .line 427
    .end local v9    # "ee":Ljava/lang/NumberFormatException;
    :catchall_0
    move-exception v1
