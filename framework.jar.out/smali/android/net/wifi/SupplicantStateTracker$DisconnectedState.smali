...
.method public enter()V
    ...
    invoke-static {v2}, Landroid/net/wifi/SupplicantStateTracker;->access$1000(Landroid/net/wifi/SupplicantStateTracker;)Landroid/os/Message;
    ...
    if-ge v2, v6, :cond_miui_0

    iget v2, v1, Landroid/net/wifi/StateChangeResult;->networkId:I
 
    iget-object v6, p0, Landroid/net/wifi/SupplicantStateTracker$DisconnectedState;->this$0:Landroid/net/wifi/SupplicantStateTracker;
 
    # getter for: Landroid/net/wifi/SupplicantStateTracker;->mAuthenticationFailuresCount:I
    invoke-static {v6}, Landroid/net/wifi/SupplicantStateTracker;->access_mAuthenticationFailuresCount(Landroid/net/wifi/SupplicantStateTracker;)I
 
    move-result v6
 
    invoke-static {v2, v6}, Landroid/net/wifi/SupplicantStateTrackerInjector;->isConformAuthFailure(II)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/SupplicantStateTracker;->access$800(Landroid/net/wifi/SupplicantStateTracker;)I
    ...
    invoke-static {v2, v5}, Landroid/net/wifi/SupplicantStateTracker;->access$802(Landroid/net/wifi/SupplicantStateTracker;I)I
