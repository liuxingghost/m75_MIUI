...
.method public enter()V
    ...
    invoke-static {v0, v4}, Landroid/net/wifi/p2p/WifiP2pService;->access$1902(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v0, v4}, Landroid/net/wifi/p2p/WifiP2pService;->access$2002(Landroid/net/wifi/p2p/WifiP2pService;Z)Z

    .line 1139
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pDisabledState;->this$1:Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;

    # getter for: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWifiMonitor:Landroid/net/wifi/WifiMonitor;
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$2100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/WifiMonitor;

    move-result-object v0

    invoke-virtual {v0}, Landroid/net/wifi/WifiMonitor;->isMonitoring()Z
    ...
    # ++operator for: Landroid/net/wifi/p2p/WifiP2pService;->mStopP2pMonitorTimeoutIndex:I
    invoke-static {}, Landroid/net/wifi/p2p/WifiP2pService;->access$2204()I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-interface {v3, v5}, Landroid/os/INetworkManagementService;->setInterfaceUp(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$2300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$P2pEnablingState;
    ...
    const-string/jumbo v6, "setInterfaceUp/disableIpv6 exception: "
    ...
    invoke-static {v3}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$2500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
    ...
    # setter for: Landroid/net/wifi/p2p/WifiP2pService;->mGoFastConnectEnaled:Z
    invoke-static {v3, v4}, Landroid/net/wifi/p2p/WifiP2pService;->access$1902(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v5, v3}, Landroid/net/wifi/p2p/WifiP2pService;->access$2602(Landroid/net/wifi/p2p/WifiP2pService;Landroid/net/wifi/p2p/fastconnect/WifiP2pFastConnectInfo;)Landroid/net/wifi/p2p/fastconnect/WifiP2pFastConnectInfo;
    ...
    # setter for: Landroid/net/wifi/p2p/WifiP2pService;->mGcFastConnectEnaled:Z
    invoke-static {v3, v4}, Landroid/net/wifi/p2p/WifiP2pService;->access$2002(Landroid/net/wifi/p2p/WifiP2pService;Z)Z

    goto/16 :goto_2

    .line 1179
    :sswitch_3
    # getter for: Landroid/net/wifi/p2p/WifiP2pService;->mStopP2pMonitorTimeoutIndex:I
    invoke-static {}, Landroid/net/wifi/p2p/WifiP2pService;->access$2200()I
    ...
    invoke-virtual {v3}, Landroid/net/wifi/WifiMonitor;->isMonitoring()Z
    ...
    invoke-virtual {v3}, Landroid/net/wifi/WifiMonitor;->stopMonitoring()V
    ...
    invoke-virtual {v3}, Landroid/net/wifi/WifiNative;->stopDriver()Z
