...
.method public enter()V
    ...
    # invokes: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->isDeviceBeWfdSink()Z
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Z
    ...
    # invokes: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->sendP2pGOandGCRequestConnectBroadcast()V
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$11600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    # invokes: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->isDeviceBeWfdSink()Z
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Z
    ...
    iput v2, v1, Landroid/net/wifi/p2p/WifiP2pConfig;->groupOwnerIntent:I
    ...
    const-string v3, "User accept negotiation: mSavedPeerConfig = "
    ...
    # getter for: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mSavedPeerConfig:Landroid/net/wifi/p2p/WifiP2pConfig;
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8000(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pConfig;
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$11700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pConfig;)V
