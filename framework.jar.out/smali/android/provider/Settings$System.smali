...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/provider/Settings$System$ScreenBrightnessMode;
    }
.end annotation


# static fields
.field public static final AAL_FUNCTION:Ljava/lang/String; = "aal_function"

.field public static final AAL_FUNC_CABC:I = 0x2

.field public static final AAL_FUNC_DRE:I = 0x4

.field public static final AAL_FUNC_LABC:I = 0x1
...
.field public static final DISABLE_AAL:Ljava/lang/String; = "disable_aal"
...
.field public static final SCREEN_BRIGHTNESS_OF_AUTO_MODE:Ljava/lang/String; = "screen_brightness_of_auto_mode"
...
.method public static getScreenBrightnessMode(Landroid/content/ContentResolver;I)Landroid/provider/Settings$System$ScreenBrightnessMode;
    .locals 5
    .param p0, "cr"    # Landroid/content/ContentResolver;
    ...
    .line 1977
    invoke-static {p0, p1}, Landroid/provider/Settings$System;->getScreenBrightnessModeRaw(Landroid/content/ContentResolver;I)Landroid/provider/Settings$System$ScreenBrightnessMode;

    move-result-object v1

    .line 1980
    .local v1, "scrMode":Landroid/provider/Settings$System$ScreenBrightnessMode;
    const-string v4, "disable_aal"
    ...
    .line 1982
    .local v0, "disableAAL":Z
    :goto_0
    if-nez v0, :cond_1

    :goto_1
    invoke-virtual {v1, v2}, Landroid/provider/Settings$System$ScreenBrightnessMode;->overwriteEnabled(Z)V

    .line 1984
    return-object v1

    .end local v0    # "disableAAL":Z
    :cond_0
    move v0, v3
...
.method private static getScreenBrightnessModeRaw(Landroid/content/ContentResolver;I)Landroid/provider/Settings$System$ScreenBrightnessMode;
    .locals 5
    .param p0, "cr"    # Landroid/content/ContentResolver;
    .param p1, "userHandle"    # I
    ...
    invoke-static {p0, v4, v2, p1}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    .line 1966
    :goto_0
    const-string v4, "aal_function"

    invoke-static {p0, v4, v0, p1}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I

    move-result v1

    .line 1968
    .local v1, "func":I
    new-instance v4, Landroid/provider/Settings$System$ScreenBrightnessMode;

    invoke-direct {v4, v2, v3, v1, v3}, Landroid/provider/Settings$System$ScreenBrightnessMode;-><init>(ZZIZ)V
...
.method public static setAALEnabled(Landroid/content/ContentResolver;Z)V
    .locals 3
    .param p0, "cr"    # Landroid/content/ContentResolver;
    .param p1, "enabled"    # Z
    ...
    const-string/jumbo v2, "setAALEnabled: "
...
.method public static setAALFunction(Landroid/content/ContentResolver;III)V
    .locals 4
    .param p0, "cr"    # Landroid/content/ContentResolver;
    .param p1, "funcChanged"    # I
    .param p2, "funcEn"    # I
    .param p3, "userHandle"    # I
    ...
    const-string/jumbo v3, "setAALFunction: changed="
    ...
    .line 2032
    invoke-static {p0, p3}, Landroid/provider/Settings$System;->getScreenBrightnessModeRaw(Landroid/content/ContentResolver;I)Landroid/provider/Settings$System$ScreenBrightnessMode;

    move-result-object v0

    .line 2034
    .local v0, "scrMode":Landroid/provider/Settings$System$ScreenBrightnessMode;
    invoke-virtual {v0}, Landroid/provider/Settings$System$ScreenBrightnessMode;->getAALFunction()I
    ...
    .line 2035
    const-string v1, "aal_function"

    invoke-static {p0, v1, p2, p3}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    invoke-static {p0, v1, v2, p3}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
...
.method public static setScreenBrightnessMode(Landroid/content/ContentResolver;ZZZZI)V
    .locals 5
    .param p0, "cr"    # Landroid/content/ContentResolver;
    .param p1, "autoChanged"    # Z
    .param p2, "isAutoOn"    # Z
    .param p3, "ecoChanged"    # Z
    .param p4, "isEcoOn"    # Z
    ...
    const-string/jumbo v4, "setScreenBrightnessMode: auto changed="
    ...
    .line 1997
    invoke-static {p0, p5}, Landroid/provider/Settings$System;->getScreenBrightnessModeRaw(Landroid/content/ContentResolver;I)Landroid/provider/Settings$System$ScreenBrightnessMode;

    move-result-object v1

    .line 1999
    .local v1, "scrMode":Landroid/provider/Settings$System$ScreenBrightnessMode;
    invoke-virtual {v1}, Landroid/provider/Settings$System$ScreenBrightnessMode;->isAutoOn()Z

    move-result v2

    if-ne p2, v2, :cond_0

    invoke-virtual {v1}, Landroid/provider/Settings$System$ScreenBrightnessMode;->isEcoOn()Z
    ...
    invoke-static {p0, v2, v0, p5}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    :goto_1
    invoke-static {p0, v3, v2, p5}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
...
.method public static syncAALOnBrightnessModeChanged(Landroid/content/ContentResolver;I)V
    .locals 5
    .param p0, "cr"    # Landroid/content/ContentResolver;
    .param p1, "userHandle"    # I
    ...
    const-string/jumbo v4, "syncAALOnBrightnessModeChanged: isAutoOn="
    ...
    const-string v4, " AALFunction="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    invoke-virtual {v1}, Landroid/provider/Settings$System$ScreenBrightnessMode;->getAALFunction()I
    ...
    invoke-static {p0, v2, v3, p1}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
