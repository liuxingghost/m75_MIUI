...
.method public run()V
    ...
    invoke-static {v7}, Lcom/android/server/InputMethodManagerService;->access$1800(Lcom/android/server/InputMethodManagerService;)I
    ...
    invoke-static {v9}, Lcom/android/server/InputMethodManagerService;->access$1900(Lcom/android/server/InputMethodManagerService;)I
    ...
    invoke-static {v7}, Lcom/android/server/InputMethodManagerService;->access$2000(Lcom/android/server/InputMethodManagerService;)Lcom/android/server/InputMethodManagerService$InputMethodAndSubtypeListManager;
    ...
    invoke-static {v7}, Lcom/android/server/InputMethodManagerService;->access$2100(Lcom/android/server/InputMethodManagerService;)Landroid/view/inputmethod/InputMethodSubtype;
    ...
    # getter for: Lcom/android/server/InputMethodManagerService;->index2:I
    invoke-static {v10}, Lcom/android/server/InputMethodManagerService;->access$1800(Lcom/android/server/InputMethodManagerService;)I
    ...
    invoke-static {v7, v2}, Lcom/android/server/InputMethodManagerService;->access$1812(Lcom/android/server/InputMethodManagerService;I)I
    ...
    # += operator for: Lcom/android/server/InputMethodManagerService;->index2:I
    invoke-static {v7, v6}, Lcom/android/server/InputMethodManagerService;->access$1812(Lcom/android/server/InputMethodManagerService;I)I
    ...
    invoke-static {v7, v9}, Lcom/android/server/InputMethodManagerService;->access$1902(Lcom/android/server/InputMethodManagerService;I)I
    ...
    invoke-static {v7}, Lcom/android/server/InputMethodManagerService;->access$2200(Lcom/android/server/InputMethodManagerService;)Ljava/util/Timer;
    ...
    invoke-static {v7, v9}, Lcom/android/server/InputMethodManagerService;->access$2202(Lcom/android/server/InputMethodManagerService;Ljava/util/Timer;)Ljava/util/Timer;
