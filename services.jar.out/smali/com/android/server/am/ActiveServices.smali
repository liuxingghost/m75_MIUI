...
.field static DEBUG_DELAYED_STATS:Z = false
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/ActiveServices;->DEBUG_DELAYED_STATS:Z
...
.method private final bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZ)Ljava/lang/String;
    ...
    .line 1340
    sget-boolean v1, Lcom/android/server/am/ActiveServices;->DEBUG_DELAYED_STATS:Z
    ...
    const-string v4, "REM FR DELAY LIST (bring up): "
    ...
    const-string v4, "bringUpServiceLocked: appInfo.uid="
    ...
    const-string v4, "Applying delayed stop (in bring up): "
...
.method private final realStartServiceLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/ProcessRecord;Z)V
    ...
    .line 1502
    sget-boolean v0, Lcom/android/server/am/ActiveServices;->DEBUG_DELAYED_STATS:Z
...
.method private serviceDoneExecutingLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/am/ANRManager$AnrMonitorHandler;->removeMessages(ILjava/lang/Object;)V
...
.method clearBgServiceForBroadcast()V
    .locals 5
...
.method final killServicesLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    const-string v11, "SVC-mCachedServices add num="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, p1, Lcom/android/server/am/ProcessRecord;->services:Landroid/util/ArraySet;
    ...
    .line 2122
    :cond_0
    iget-object v9, p0, Lcom/android/server/am/ActiveServices;->mCachedServices:Landroid/util/ArraySet;
    ...
    invoke-virtual {v9, v10}, Landroid/util/ArraySet;->putAll(Landroid/util/ArraySet;)V
    ...
    const-string v11, "killServices remove destroying "
    ...
    iget-object v9, v9, Lcom/android/server/am/ActivityManagerService;->mWallpaperProcess:Lcom/android/server/am/ProcessRecord;

    if-ne p1, v9, :cond_c

    iget-object v9, p0, Lcom/android/server/am/ActiveServices;->mAm:Lcom/android/server/am/ActivityManagerService;

    iget-boolean v9, v9, Lcom/android/server/am/ActivityManagerService;->mIsWallpaperFg:Z
    ...
    iput-object v10, v9, Lcom/android/server/am/ActivityManagerService;->mWallpaperProcess:Lcom/android/server/am/ProcessRecord;
...
.method scheduleServiceTimeoutLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-object v7, v5, Lcom/android/server/am/ActivityManagerService;->mHandler:Landroid/os/Handler;
    ...
    :goto_1
    invoke-virtual {v7, v0, v5, v6}, Landroid/os/Handler;->sendMessageAtTime(Landroid/os/Message;J)Z
    ...
    iget-object v5, v5, Lcom/android/server/am/ActivityManagerService;->mAnrHandler:Lcom/android/server/am/ANRManager$AnrMonitorHandler;

    const/16 v6, 0x3ea

    invoke-virtual {v5, v6, p1}, Lcom/android/server/am/ANRManager$AnrMonitorHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v5, v1, v6, v7}, Lcom/android/server/am/ANRManager$AnrMonitorHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/am/ANRManager$AnrMonitorHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v5, v2, v6, v7}, Lcom/android/server/am/ANRManager$AnrMonitorHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
...
.method startServiceInnerLocked(Lcom/android/server/am/ActiveServices$ServiceMap;Landroid/content/Intent;Lcom/android/server/am/ServiceRecord;ZZ)Landroid/content/ComponentName;
    ...
    :cond_5
    sget-boolean v4, Lcom/android/server/am/ActiveServices;->DEBUG_DELAYED_STATS:Z
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;III)Landroid/content/ComponentName;
    ...
    .prologue
    .line 294
    sget-boolean v2, Lcom/android/server/am/ActiveServices;->DEBUG_DELAYED_STATS:Z
