...
.field static final HALT_RESUMING_TIMEOUT_MSG:I = 0x69
...
.field static final RESTORE_RESUMING_MSG:I = 0x6a
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Landroid/os/Looper;)V
    ...
    .line 229
    iput-boolean v3, p0, Lcom/android/server/am/ActivityStackSupervisor;->mIsPerfBoostEnable:Z
    ...
    iput-object v1, p0, Lcom/android/server/am/ActivityStackSupervisor;->mHaltActivityLock:Ljava/lang/Object;

    .line 232
    iput-boolean v3, p0, Lcom/android/server/am/ActivityStackSupervisor;->mHaltActivity:Z
...
.method static synthetic access$000(Lcom/android/server/am/ActivityStackSupervisor;)Ljava/util/ArrayList;
    .locals 1
...
.method final activityIdleInternalLocked(Landroid/os/IBinder;ZLandroid/content/res/Configuration;)Lcom/android/server/am/ActivityRecord;
    ...
    .prologue
    .line 1976
    sget-boolean v2, Lcom/android/server/am/ActivityManagerService;->localLOGV:Z
    ...
    iget-boolean v2, v0, Lcom/android/server/am/ActivityStackSupervisor;->mIsPerfBoostEnable:Z
    ...
    iput-boolean v2, v0, Lcom/android/server/am/ActivityStackSupervisor;->mIsPerfBoostEnable:Z
...
.method adjustStackFocus(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityStack;
    ...
    .line 1351
    sget-boolean v5, Lcom/android/server/am/ActivityManagerService;->DEBUG_FOCUS:Z
...
.method ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;I)V
    ...
    .prologue
    .line 2477
    iget-object v6, p0, Lcom/android/server/am/ActivityStackSupervisor;->mHaltActivityLock:Ljava/lang/Object;
    ...
    iget-boolean v5, p0, Lcom/android/server/am/ActivityStackSupervisor;->mHaltActivity:Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/am/ActivityStackSupervisor;->checkIfBlockResumeTop(Lcom/android/server/am/ActivityRecord;)Z
    ...
    .line 2484
    .end local v0    # "showHomeBehindStack":Z
    .end local v1    # "stack":Lcom/android/server/am/ActivityStack;
    .end local v2    # "stackNdx":I
    ...
    .line 2497
    .restart local v0    # "showHomeBehindStack":Z
    .restart local v2    # "stackNdx":I
    .restart local v3    # "top":Lcom/android/server/am/ActivityRecord;
    .restart local v4    # "topStack":Lcom/android/server/am/ActivityStack;
    :cond_3
    iget-object v5, p0, Lcom/android/server/am/ActivityStackSupervisor;->mStacks:Ljava/util/ArrayList;
...
.method setFocusedStack(Lcom/android/server/am/ActivityRecord;)V
    ...
    sget-boolean v1, Lcom/android/server/am/ActivityManagerService;->DEBUG_FOCUS:Z
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIILjava/lang/String;ILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    iget-object v5, v5, Lcom/android/server/am/ActivityManagerService;->mPreviousProcess2:Lcom/android/server/am/ProcessRecord;
    ...
    const-string v9, "mPreviousProcess2 process = "
    ...
    iput-object v8, v5, Lcom/android/server/am/ActivityManagerService;->mPreviousProcess2:Lcom/android/server/am/ProcessRecord;
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILjava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;I)I
    ...
    .line 684
    invoke-virtual/range {v3 .. v9}, Lcom/android/server/am/ActivityStackSupervisor;->resolveActivity(Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Landroid/os/ParcelFileDescriptor;I)Landroid/content/pm/ActivityInfo;
    ...
    .line 694
    .local v34, "permission":Ljava/lang/String;
    const/16 v30, 0x0

    .line 695
    .local v30, "mMobileManager":Lcom/mediatek/common/mom/IMobileManagerService;
    ...
    .line 696
    .local v25, "binder":Landroid/os/IBinder;
    invoke-static/range {v25 .. v25}, Lcom/mediatek/common/mom/IMobileManagerService$Stub;->asInterface(Landroid/os/IBinder;)Lcom/mediatek/common/mom/IMobileManagerService;
    ...
    .line 698
    const-string v34, "sub-permission.MAKE_CALL"

    .line 699
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/am/ActivityStackSupervisor;->mContext:Landroid/content/Context;
    ...
    .end local v25    # "binder":Landroid/os/IBinder;
    .end local v27    # "data":Landroid/os/Bundle;
    .end local v30    # "mMobileManager":Lcom/mediatek/common/mom/IMobileManagerService;
    .end local v34    # "permission":Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStackSupervisor;->mWaitingActivityLaunched:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStackSupervisor;->mWaitingActivityVisible:Ljava/util/ArrayList;
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
    ...
    const-string v8, "launchFlags(original): 0x"
    ...
    const-string v8, "ACT-launchFlags(original): 0x"
    ...
    const-string v8, "launchFlags(update): 0x"
    ...
    iput-boolean v6, v4, Lcom/android/server/am/TaskRecord;->mMovingToFront:Z
    ...
    const-string v8, "START_RETURN_INTENT_TO_CALLER, doResume = "
    ...
    const-string v8, "START_TASK_TO_FRONT, doResume = "
    ...
    const-string v8, "ACT-AM_NEW_INTENT "
    ...
    iget-object v8, v15, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    const-string v6, "place the new activity on top of the current task..."
    ...
    const-string v8, "ACT-AM_CREATE_TASK "
    ...
    const-string v8, "ACT-AM_CREATE_ACTIVITY "
    ...
    const-string v8, "WMS moveTaskToTop after AMS clear task, r = "
