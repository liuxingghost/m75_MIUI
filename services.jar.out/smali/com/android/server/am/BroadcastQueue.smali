...
#   invoke-static {p0, v2, p1, v3, v4}, Lcom/android/server/am/BroadcastQueueInjector;->checkReceiverAppDealBroadcast(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;Z)Z
 
#   move-result v2
 
    if-nez v2, :cond_miui_9
...
.method final broadcastTimeoutLocked(Z)V
    ...
    .line 1106
    .local v19, "record":Lcom/android/server/am/ProcessRecord;
    if-eqz v19, :cond_9
    ...
    invoke-static {v0, v5, v6}, Lcom/android/server/am/ANRManager;->extendANRTime(IJ)J

    move-result-wide v15

    .line 1108
    .local v15, "extendTime":J
    ...
    .line 1117
    .restart local v15    # "extendTime":J
...
.method final setBroadcastTimeoutLocked(J)V
    ...
    .line 985
    iget-object v3, p0, Lcom/android/server/am/BroadcastQueue;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v3, v0, p1, p2}, Landroid/os/Handler;->sendMessageAtTime(Landroid/os/Message;J)Z
    ...
    invoke-virtual {v3, v4, p0}, Lcom/android/server/am/ANRManager$AnrMonitorHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v3, v1, v4, v5}, Lcom/android/server/am/ANRManager$AnrMonitorHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/am/ANRManager$AnrMonitorHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v3, v2, v4, v5}, Lcom/android/server/am/ANRManager$AnrMonitorHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
