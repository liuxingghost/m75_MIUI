...
.method maybeRescheduleSync(Landroid/content/SyncResult;Lcom/android/server/content/SyncOperation;)V
    ...
    const-string v5, "not retrying sync operation because SYNC_EXTRAS_DO_NOT_RETRY was specified "
    ...
    iget-boolean v3, v0, Landroid/content/SyncResult;->tooManyRetries:Z
    ...
    const-string v5, "not retrying sync operation because it retried too many times: "
    ...
    const-string v4, "retrying sync operation because even though it had an error it achieved some success"
    ...
    const-string v5, "retrying sync operation that failed because there was already a sync in progress: "
    ...
    .line 989
    .local v2, "newSyncOperation":Lcom/android/server/content/SyncOperation;
    const-wide/16 v3, 0x1f4

    invoke-virtual {v2, v3, v4}, Lcom/android/server/content/SyncOperation;->setDelayRunTime(J)V
    ...
    .line 991
    .end local v2    # "newSyncOperation":Lcom/android/server/content/SyncOperation;
    :cond_8
    ...
    const-string v5, "retrying sync operation because it encountered a soft error: "
